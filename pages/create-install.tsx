  ...
  return (
    <>
      ...
      <div className="flex items-center h-full w-full bg-slate-200 ">
        <div className="flex flex-col items-center h-full w-full bg-slate-200 p-8 md:max-w-md md:mx-auto md:items-start">

          <div className="flex flex-col">


            <h1 className="font-ptserif text-gray-700 text-4xl mt-20">Create a new install.</h1>
