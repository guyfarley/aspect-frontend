// Modification form for selected installation
...
// On submission, routes to pages/installs/[id] for modified installation
        ...
        <div className="flex flex-col items-center h-full w-full bg-slate-200 p-8 md:max-w-md md:mx-auto">
          ...
          <form className="mb-6 mt-[15px] md:flex md:flex-wrap md:justify-between" onSubmit={handleSubmit}>
            <div className="flex flex-col mb-4 md:w-1/2">
              ...
              <input className="border py-2 px-3 text-grey-darkest md:mr-2" type="number" id="store_number" name="storeNum" defaultValue={(formData.storeNum).toString()} onChange={handleChange} />
            </div>
            <div className="flex flex-col mb-4 md:w-1/2">
            ...
            <div className="flex flex-col mb-4 md:w-full">
              ...
              <input className="border py-2 px-3 text-grey-darkest" type="text" id="vendor" name="vendorName" defaultValue={formData.vendorName} onChange={handleChange} />
            </div>
            <div className="flex flex-col mb-4 md:w-full">
              <label className="mb-2 uppercase font-bold text-sm text-grey-darkest" htmlFor="vendor_phone">Vendor Phone #</label>
              <input className="border py-2 px-3 text-grey-darkest" type="tel" id="vendor_phone" name="vendorPhone" defaultValue={(formData.vendorPhone).toString()} onChange={handleChange} />
            </div>
            <div className="flex flex-col mb-4 md:w-1/2">
            ...
            <div className="flex flex-col mb-4 md:w-full">
              ...
              <input className="border py-2 px-3 text-grey-darkest" type="tel" id="installer_phone" name="installerPhone" defaultValue={(formData.installerPhone).toString()} onChange={handleChange} />
            </div>
            <div className="flex flex-col mb-4 md:w-full">
              <label className="mb-2 uppercase font-bold text-sm text-grey-darkest" htmlFor="installer_notes">Installer Notes</label>
              <input className="border py-2 px-3 text-grey-darkest" type="text" id="installer_notes" name="installerNotes" defaultValue={(formData.installerNotes)} onChange={handleChange} />
            </div>
            <div className="flex mb-4 md:w-full">
              ...
              <input className="border mb-[6px] ml-3 px-3 text-grey-darkest" type="checkbox" id="complete" name="complete" defaultChecked={(formData.complete)} onChange={handleChange} />
            </div>
            <div className="flex mb-4 md:w-full">
              <label className="mb-2 uppercase font-bold text-sm text-grey-darkest" htmlFor="revisit">Revisit Needed?</label>
              <input className="border mb-[6px] ml-3 px-3 text-grey-darkest" type="checkbox" id="revisit" name="revisitNeeded" defaultChecked={(formData.revisitNeeded)} onChange={handleChange} />
            </div>
            <div className="flex flex-col mb-4 md:w-1/2">
            ...
            <div className="flex flex-col mb-4 md:w-full">
              ...
              <input className="border py-2 px-3 text-grey-darkest" type="text" id="pm_notes" name="pmNotes" defaultValue={(formData.pmNotes)} onChange={handleChange} />
            </div>
